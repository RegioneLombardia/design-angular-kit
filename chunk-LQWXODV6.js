...
}`]],template:function(i,t){i&1&&f(0,"it-radio-example")(1,"it-source-display",0)(2,"it-radio-checked-example")(3,"it-source-display",1)},dependencies:[J,Z,$]});let a=e;return a})();var te=(()=>{let e=class e{constructor(){this.component=K.components.find(m=>m.name==="ItRadioButtonComponent")}};e.\u0275fac=function(i){return new(i||e)},e.\u0275cmp=u({type:e,selectors:[["it-radio-index"]],decls:10,vars:2,consts:[[1,"bd-title"],[1,"bd-lead"],[3,"innerHTML"],["label","Esempi","active","true",1,"pt-3"],["label","API",1,"pt-3"],[3,"component"]],template:function(i,t){i&1&&(n(0,"h1",0),l(1,"Radio Button"),o(),n(2,"p",1),l(3,"Il componente Radio Button utilizzabile in un form"),o(),f(4,"div",2),n(5,"it-tab-container")(6,"it-tab-item",3),f(7,"it-radio-examples"),o(),n(8,"it-tab-item",4),f(9,"it-api-parameters",5),o()()),i&2&&(d(4),g("innerHTML",t.component.description,z),d(5),g("component",t.component))},dependencies:[X,Q,V,ee]});let a=e;return a})();var me=[{path:"",component:te}],ne=(()=>{let e=class e{};e.\u0275fac=function(i){return new(i||e)},e.\u0275mod=x({type:e}),e.\u0275inj=v({imports:[F.forChild(me),F]});let a=e;return a})();var We=(()=>{let e=class e{};e.\u0275fac=function(i){return new(i||e)},e.\u0275mod=x({type:e}),e.\u0275inj=v({imports:[T,H,j,Y,ne]});let a=e;return a})();export{We as RadioModule};
