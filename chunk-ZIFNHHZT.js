...
}`]],template:function(l,e){l&1&&c(0,"it-form-input-example")(1,"it-source-display",0)(2,"it-form-input-number-example")(3,"it-source-display",1)(4,"it-form-input-calendar-example")(5,"it-source-display",2)(6,"it-form-input-icon-example")(7,"it-source-display",3)(8,"it-template-driven-validation-example")(9,"it-source-display",4)(10,"it-model-driven-validation-example")(11,"it-source-display",5)},dependencies:[se,ve,be,he,ye,Ce,_e]});let a=t;return a})();var xe=(()=>{let t=class t{constructor(){this.component=ue.components.find(u=>u.name==="ItInputComponent")}};t.\u0275fac=function(l){return new(l||t)},t.\u0275cmp=b({type:t,selectors:[["it-form-input-index"]],decls:10,vars:2,consts:[[1,"bd-title"],[1,"bd-lead"],[3,"innerHTML"],["label","Esempi","active","true",1,"pt-3"],["label","API",1,"pt-3"],[3,"component"]],template:function(l,e){l&1&&(o(0,"h1",0),m(1,"Form Input"),n(),o(2,"p",1),m(3,"Il componente Form Input utilizzabile in un form"),n(),c(4,"div",2),o(5,"it-tab-container")(6,"it-tab-item",3),c(7,"it-form-input-examples"),n(),o(8,"it-tab-item",4),c(9,"it-api-parameters",5),n()()),l&2&&(r(4),p("innerHTML",e.component.description,j),r(5),p("component",e.component))},dependencies:[ce,re,le,Me]});let a=t;return a})();var Oe=[{path:"",component:xe}],Ie=(()=>{let t=class t{};t.\u0275fac=function(l){return new(l||t)},t.\u0275mod=P({type:t}),t.\u0275inj=L({imports:[G.forChild(Oe),G]});let a=t;return a})();var wt=(()=>{let t=class t{};t.\u0275fac=function(l){return new(l||t)},t.\u0275mod=P({type:t}),t.\u0275inj=L({imports:[K,oe,ge,Ie,ae]});let a=t;return a})();export{wt as FormInputModule};
