...
}`]],template:function(d,i){d&1&&g(0,"it-notifications-setup")(1,"it-notifications-example-type")(2,"it-source-display",0)(3,"it-notifications-example")(4,"it-source-display",1)},dependencies:[B,A,H,Y],encapsulation:2});let m=o;return m})();var G=(()=>{let o=class o{constructor(){this.component=I.components.find(u=>u.name==="ItNotificationsComponent"),this.service=I.injectables.find(u=>u.name==="ItNotificationService")}};o.\u0275fac=function(d){return new(d||o)},o.\u0275cmp=y({type:o,selectors:[["it-notifications-index"]],standalone:!1,decls:14,vars:2,consts:[[1,"bd-title"],[1,"bd-lead"],["label","Esempi","active","true",1,"pt-3"],["label","API",1,"pt-3"],[3,"component"],[3,"service"]],template:function(d,i){d&1&&(e(0,"h1",0),r(1,"Notifiche"),n(),e(2,"p",1),r(3,"Per attirare l\u2019attenzione su brevi messaggi di stato."),n(),e(4,"it-tab-container")(5,"it-tab-item",2),g(6,"it-notifications-examples"),n(),e(7,"it-tab-item",3)(8,"h3"),r(9,"NotificationComponent"),n(),g(10,"it-api-parameters",4),e(11,"h3"),r(12,"NotificationService"),n(),g(13,"it-api-parameters",5),n()()),d&2&&(a(10),s("component",i.component),a(3),s("service",i.service))},dependencies:[O,F,j,q],encapsulation:2});let m=o;return m})();var ni=[{path:"",component:G}],J=(()=>{let o=class o{};o.\u0275fac=function(d){return new(d||o)},o.\u0275mod=M({type:o}),o.\u0275inj=v({imports:[k.forChild(ni),k]});let m=o;return m})();var Fi=(()=>{let o=class o{};o.\u0275fac=function(d){return new(d||o)},o.\u0275mod=M({type:o}),o.\u0275inj=v({imports:[L,R,J,z]});let m=o;return m})();export{Fi as NotificationsModule};
