...
}`]],template:function(n,l){n&1&&r(0,"it-back-button-link")(1,"it-source-display",0)(2,"it-back-button-button")(3,"it-source-display",1)(4,"it-back-button-only-icon")(5,"it-source-display",2)},dependencies:[B,M,T,E],encapsulation:2});let e=t;return e})();var L=(()=>{let t=class t{constructor(){this.component=S.components.find(a=>a.name==="ItBackButtonComponent")}};t.\u0275fac=function(n){return new(n||t)},t.\u0275cmp=m({type:t,selectors:[["it-go-back-index"]],decls:10,vars:2,consts:[[1,"bd-title"],[1,"bd-lead"],[3,"innerHTML"],["label","Esempi","active","true",1,"mt-3"],["label","API",1,"mt-3"],[3,"component"]],template:function(n,l){n&1&&(o(0,"h1",0),c(1,"BackButton"),i(),o(2,"p",1),c(3,`Consente agli utenti di avere un link o pulsante con un'azione equivalente al "torna indietro" del browser.`),i(),r(4,"div",2),o(5,"it-tab-container")(6,"it-tab-item",3),r(7,"it-back-button-examples"),i(),o(8,"it-tab-item",4),r(9,"it-api-parameters",5),i()()),n&2&&(p(4),s("innerHTML",l.component.description,k),p(5),s("component",l.component))},dependencies:[w,x,C,D],encapsulation:2});let e=t;return e})();var O=[{path:"",component:L}],F=(()=>{let t=class t{};t.\u0275fac=function(n){return new(n||t)},t.\u0275mod=f({type:t}),t.\u0275inj=b({imports:[v.forChild(O),v]});let e=t;return e})();var mt=(()=>{let t=class t{};t.\u0275fac=function(n){return new(n||t)},t.\u0275mod=f({type:t}),t.\u0275inj=b({imports:[y,I,h,F]});let e=t;return e})();export{mt as BackButtonModule};
