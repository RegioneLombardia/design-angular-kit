...
}`]],template:function(i,r){i&1&&m(0,"it-timeline-default-example")(1,"it-source-display",0)},dependencies:[C,R],encapsulation:2});let t=e;return t})();var P=(()=>{let e=class e{constructor(){this.component=f.components.find(n=>n.name==="ItTimelineComponent")}};e.\u0275fac=function(i){return new(i||e)},e.\u0275cmp=l({type:e,selectors:[["it-timeline-index"]],standalone:!1,decls:10,vars:2,consts:[[1,"bd-title"],[1,"bd-lead"],[3,"innerHTML"],["label","Esempi","active","true",1,"pt-3"],["label","API",1,"pt-3"],[3,"component"]],template:function(i,r){i&1&&(o(0,"h1",0),p(1,"Timeline"),a(),o(2,"p",1),p(3,"Componente per la visualizzazione cronologica di eventi."),a(),m(4,"div",2),o(5,"it-tab-container")(6,"it-tab-item",3),m(7,"it-timeline-examples"),a(),o(8,"it-tab-item",4),m(9,"it-api-parameters",5),a()()),i&2&&(d(4),s("innerHTML",r.component.description,T),d(5),s("component",r.component))},dependencies:[g,S,D,x],encapsulation:2});let t=e;return t})();var v=[{path:"",component:P}],U=(()=>{let e=class e{};e.\u0275fac=function(i){return new(i||e)},e.\u0275mod=u({type:e}),e.\u0275inj=c({imports:[I.forChild(v),I]});let t=e;return t})();var Z=(()=>{let e=class e{};e.\u0275fac=function(i){return new(i||e)},e.\u0275mod=u({type:e}),e.\u0275inj=c({imports:[O,L,U]});let t=e;return t})();export{Z as TimelineModule};
